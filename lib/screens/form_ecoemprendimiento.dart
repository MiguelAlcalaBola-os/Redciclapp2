...
class RegisterEcoemprendimiento extends StatefulWidget {
  ...
  @override
  State<RegisterEcoemprendimiento> createState() => _RegisterEcoemprendimientoState();
}
...
class _RegisterEcoemprendimientoState extends State<RegisterEcoemprendimiento> {
  ...
  String _comboNivel;
  List _itemNivel = ["Capacidad maxima alcanzada", "Todavia podemos recibir", "Estamos recibiendo"];
  ...
  Widget _direccion() {
    return TextFormField(
        ...
        decoration: const InputDecoration(
          ...
          helperText: 'Donde podran encontrarles y dejar los materiales y/o residuos',
      ...
      child: ElevatedButton(
          ...
          onPressed: () async {
            if (_formRecicladora.currentState.validate()) {
              bool resp = await EcoemprendimientoServices().guardarEcoemprendimiento(
                  _nombreCompletoController.text,
                  _comboCiudad,
                  _comboZona,
                  hoy,
                  _numeroCelularController.text,
                  _aqueseDedicanController.text,
                  _queResiduosController.text,
                  _direccionController.text,
                  _horariosRecolectaController.text,
                  _comboNivel,
